...
export const colors = {
  ...
  glassButtonTextBlue: '#2563EB',
  glassButtonTextBlueSelected: '#1D4ED8',
  glassButtonStrokeBlue: 'rgba(59, 130, 246, 0.38)',
  glassButtonStrokeBlueSelected: 'rgba(37, 99, 235, 0.62)',
  glassButtonSurfaceTintIOS: 'rgba(238, 245, 255, 0.36)',
  glassButtonSurfaceTintFallback: 'rgba(241, 246, 255, 0.82)',
  glassButtonInnerHighlight: 'rgba(255, 255, 255, 0.62)',
  glassButtonShadowSoftDark: 'rgba(30, 64, 175, 0.14)',
  glassButtonShadowSoftLight: 'rgba(255, 255, 255, 0.52)',
  ...
  greatJobGlassTintIOS: 'rgba(237, 245, 255, 0.54)',
  greatJobGlassTintFallback: 'rgba(240, 246, 255, 0.88)',
